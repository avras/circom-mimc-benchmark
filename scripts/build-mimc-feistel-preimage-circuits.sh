...
node generate_witness.js mimc_feistel_hash_preimage.wasm ../mimc_feistel_preimage_input.json ../feistel_witness.wtns

cd ..
snarkjs plonk setup mimc_feistel_hash_preimage.r1cs powersOfTau28_hez_final_14.ptau mimc_feistel_preimage_final.zkey
snarkjs zkey export verificationkey mimc_feistel_preimage_final.zkey mimc_feistel_preimage_verification_key.json
